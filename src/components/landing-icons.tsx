...
export function IconZap({ className }: { className?: string }) {
  return (
    <svg className={className ?? iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
export function IconCar({ className }: { className?: string }) {
  return (
    <svg className={className ?? iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 7h8m-8 4h8m-3 4h2m-5 4v-2a2 2 0 012-2h8a2 2 0 012 2v2M5 17h14" />
    </svg>
  );
}
...
export function IconPlug({ className }: { className?: string }) {
  return (
    <svg className={className ?? iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2h6M9 10h6" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M7 18V6a2 2 0 012-2h6a2 2 0 012 2v12" />
    </svg>
  );
}
...
export function StarRating({ rating, className }: { rating: number; className?: string }) {
  ...
  return (
    <span className={`inline-flex items-center gap-0.5 ${className ?? ""}`} aria-label={`تقييم ${rating} من 5`}>
      {[1, 2, 3, 4, 5].map((i) => {
